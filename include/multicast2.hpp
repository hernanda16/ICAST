#ifndef MULTICAST2_HPP
#define MULTICAST2_HPP
...
public:
    static Multicast_2* getInstance()
    {
        static Multicast_2 instance_;
        return &instance_;
    }

    void operator=(const Multicast_2&) = delete;
    Multicast_2(Multicast_2& other) = delete;
